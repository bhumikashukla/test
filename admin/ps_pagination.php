...
class PS_Pagination {
	...
	function renderFirst($tag = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;First') {
		...
		if ($this->page == 1) {
			return ' <li><span class="page_link">' . $tag . '</span></li>';
		} else {
	 ...
	 * @return string
	 */
	function renderNav($prefix = '<li><span class="page_link1" id="page_link1">', $suffix = '</span></li>') {
		if ($this->total_rows == 0)
			return FALSE;
		...
		for($i = $start; $i <= $end; $i ++) {
			if ($i == $this->page) {
				...
				$links .= '<li><a href="' . $this->php_self . '?page=' . $i . '&' . $this->append . '">' . $i . '</a></li>' . $suffix . ' ';
			}
		}
