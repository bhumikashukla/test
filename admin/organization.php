...
if(isset($_REQUEST['task']) && $_REQUEST['task']=='delete' && $_REQUEST['id']!='' )
   {
        $sql="DELETE FROM `organizations` WHERE `id`=".$_REQUEST['id'];
		if(mysql_query($sql))
		{
	...
	<div class="container content-wrapper">
		<div class="clearfix content-left">
            <div class="section-header">
                <h1 class="clearfix section-title"><span class="fa fa-shield title-ic"></span>Manage Organizations<a id="btn-add" href="addorganization.php" class="btn btn-primary btn-main">Add Organization</a></h1>
            </div> <!--section-header-->
            ...
            <div class="section-data">
            	...
            	<div class="table-responsive data-block">
                	<h2 class="block-title"><span class="fa fa-bars title-ic"></span>Organization List</h2>
                    <div class="add-padding">
                        <table class="table table-hover table-condensed">
                            <thead>
                                <tr>
                                    <th class="col-sm-5">Organization Name</th>
							...
							<tbody>
							<?php
								$sql ="SELECT org.id as organizationid, org.name as organizationname, org.location as location, org.status as status, cat.name as categoryname from organizations org, categories cat where cat.id = org.categoryid"; 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="clearfix action-btns">
                                            <li><a href="addorganization.php?id=<?php echo $row['organizationid']; ?>" title="Edit" class="fa fa-edit"></a></li>
                                            <li><a href="organization.php?task=delete&id=<?php echo $row['organizationid']; ?>" title="Delete" class="fa fa-trash-o" onclick="return confirm('Are you sure? You want to delete this organization?');"></a></li>
                                        </ul>
                                    </td>
                                </tr>
							<?php } } ?>
