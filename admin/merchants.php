...
if(mysql_query($sql))
   {
	...
	?>
		...
		window.location.href = 'merchants.php';</script>
	 <?php 
   }
	...
	<div class="container content-wrapper">
		<div class="clearfix content-left">
            <div class="section-header">
                ...
                <h1 class="clearfix section-title"><span class="fa fa-shield title-ic"></span>Manage Merchants<a id="btn-add" href="addmerchant.php" class="btn btn-primary btn-main">Add Merchant</a></h1>
            </div> <!--section-header-->
            	...
            	<div class="table-responsive data-block">
                    ...
                    <div class="add-padding">
                        <table class="table table-hover table-condensed">
							...
							<tbody>
							<?php								
								$sql ="SELECT * FROM adminusers WHERE role = 'merchant'";								
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="clearfix action-btns">                                            
                                            <li><a href="merchants.php?task=delete&id=<?php echo $row['adminuserid']; ?>" title="Delete" class="fa fa-trash-o" onclick="return confirm('Are you sure? You want to delete this merchant?');"></a></li>
                                        </ul>
                                    </td>
                                </tr>
							<?php } } ?>
