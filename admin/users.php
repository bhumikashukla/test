<?php 
    ...
    {
		$sql="DELETE FROM `members_list` WHERE `id`=".$_REQUEST['id'];
		if(mysql_query($sql))
		{
	...
	<div class="container content-wrapper">
		<div class="clearfix content-left">
            <div class="section-header">
                <h1 class="clearfix section-title"><span class="fa fa-shield title-ic"></span>Manage Members<a id="btn-add" href="addmembers.php" class="btn btn-primary btn-main">Add member</a></h1>
            </div> <!--section-header-->
            ...
            <div class="section-data">
            	...
            	<div class="table-responsive data-block">
                	<h2 class="block-title"><span class="fa fa-bars title-ic"></span>Member List</h2>
                        ...
                        <table class="table table-hover table-condensed">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-sm-2">Mother's Name</th>
                                    <th class="col-sm-2">Member's Age</th>
                                    <th class="col-sm-2">Member's Class</th>
                                    <th class="col-sm-2">Member's School</th>
							...
							<?php								
							 ...
							 ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["member_class"];?></td>
                                    <td><?php echo $row["member_school"];?></td>
                                    <td>
                                        <ul class="clearfix action-btns">                                            
                                            <li><a href="users.php?task=delete&id=<?php echo $row['id']; ?>" title="Delete" class="fa fa-trash-o" onclick="return confirm('Are you sure? You want to delete this member?');"></a></li>
                                            <li><a href="addmembers.php?id=<?php echo $row['id']; ?>" title="Edit" class="fa fa-edit"></a></li>
                                        </ul>
                                    </td>
                                </tr>
							<?php } } ?>
